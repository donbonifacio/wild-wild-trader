...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__17514__auto__,writer__17515__auto__,opt__17516__auto__){
return cljs.core._write.call(null,writer__17515__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__16916__auto__ = reagent.impl.template.named_QMARK_.call(null,x);
...
var or__16916__auto__ = reagent.impl.template.hiccup_tag_QMARK_.call(null,x);
if(cljs.core.truth_(or__16916__auto__)){
return or__16916__auto__;
} else {
...
var temp__4655__auto__ = reagent.impl.template.obj_get.call(null,reagent.impl.template.prop_name_cache,cljs.core.name.call(null,k));
...
var G__22529 = o;
(G__22529[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
return (function() { 
var G__22530__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__22530 = function (var_args){
var args = null;
...
while (G__22531__i < G__22531__a.length) {G__22531__a[G__22531__i] = arguments[G__22531__i + 0]; ++G__22531__i;}
  args = new cljs.core.IndexedSeq(G__22531__a,0);
} 
return G__22530__delegate.call(this,args);};
G__22530.cljs$lang$maxFixedArity = 0;
G__22530.cljs$lang$applyTo = (function (arglist__22532){
var args = cljs.core.seq(arglist__22532);
return G__22530__delegate(args);
});
...
var old_22533 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_22533))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_22533)].join(''):class$));
} else {
}
...
if(cljs.core.not.call(null,(function (){var and__16904__auto__ = (node === document.activeElement);
if(and__16904__auto__){
var and__16904__auto____$1 = reagent.impl.template.has_selection_api_QMARK_.call(null,(node["type"]));
...
if(cljs.core.truth_((function (){var and__16904__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__22536 = jsprops;
(G__22536["defaultValue"] = value);

(G__22536["onChange"] = ((function (G__22536,v,value,on_change){
return (function (p1__22534_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__22534_SHARP_);
});})(G__22536,v,value,on_change))
);
...
var vec__22538 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__22538,(0),null);
var id = cljs.core.nth.call(null,vec__22538,(1),null);
var class$ = cljs.core.nth.call(null,vec__22538,(2),null);
...
var temp__4655__auto__ = reagent.impl.util.cached_react_class.call(null,tag);
if((temp__4655__auto__ == null)){
...
var temp__4655__auto__ = (function (){var G__22542 = cljs.core.meta.call(null,v);
if((G__22542 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__22542);
}
})();
if((temp__4655__auto__ == null)){
...
var jsprops = {"argv": v};
var G__22544_22545 = v;
var G__22544_22546__$1 = (((G__22544_22545 == null))?null:reagent.impl.template.key_from_vec.call(null,G__22544_22545));
if((G__22544_22546__$1 == null)){
} else {
(jsprops["key"] = G__22544_22546__$1);
}
...
var temp__4655__auto__ = reagent.impl.template.obj_get.call(null,reagent.impl.template.tag_name_cache,x);
if((temp__4655__auto__ == null)){
...
var p = (function (){var temp__4655__auto__ = (function (){var G__22549 = cljs.core.meta.call(null,argv);
if((G__22549 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__22549);
}
})();
if((temp__4655__auto__ == null)){
return jsprops;
...
var G__22550 = (((jsprops == null))?{}:jsprops);
(G__22550["key"] = key);
...
var G__22551 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__22551;
continue;
}
} else {
...
var n__17819__auto___22552 = a.length;
var i_22553 = (0);
while(true){
if((i_22553 < n__17819__auto___22552)){
(a[i_22553] = reagent.impl.template.as_element.call(null,(a[i_22553])));

var G__22554 = (i_22553 + (1));
i_22553 = G__22554;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__17819__auto___22555 = a.length;
var i_22556 = (0);
while(true){
if((i_22556 < n__17819__auto___22555)){
var val_22557 = (a[i_22556]);
if((cljs.core.vector_QMARK_.call(null,val_22557)) && ((reagent.impl.template.key_from_vec.call(null,val_22557) == null))){
(o["no-key"] = true);
} else {
}

(a[i_22556] = reagent.impl.template.as_element.call(null,val_22557));

var G__22558 = (i_22556 + (1));
i_22556 = G__22558;
continue;
} else {
}
...
if(cljs.core.truth_((function (){var and__16904__auto__ = cljs.core.not.call(null,reagent.impl.component._STAR_non_reactive_STAR_);
if(and__16904__auto__){
return (ctx["no-key"]);
} else {
return and__16904__auto__;
...
var G__22560 = (cljs.core.count.call(null,argv) - first_child);
switch (G__22560) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__22560){
...
//# sourceMappingURL=template.js.map?rel=1450953132215