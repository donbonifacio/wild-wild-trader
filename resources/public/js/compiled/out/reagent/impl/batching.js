...
var or__16916__auto__ = (w["requestAnimationFrame"]);
if(cljs.core.truth_(or__16916__auto__)){
return or__16916__auto__;
} else {
var or__16916__auto____$1 = (w["webkitRequestAnimationFrame"]);
if(cljs.core.truth_(or__16916__auto____$1)){
return or__16916__auto____$1;
} else {
var or__16916__auto____$2 = (w["mozRequestAnimationFrame"]);
if(cljs.core.truth_(or__16916__auto____$2)){
return or__16916__auto____$2;
} else {
var or__16916__auto____$3 = (w["msRequestAnimationFrame"]);
if(cljs.core.truth_(or__16916__auto____$3)){
return or__16916__auto____$3;
} else {
...
var n__17819__auto__ = a.length;
var i = (0);
while(true){
if((i < n__17819__auto__)){
var c_22465 = (a[i]);
if(cljs.core.truth_((c_22465["cljsIsDirty"]))){
(c_22465["forceUpdate"])();
} else {
}
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__17514__auto__,writer__17515__auto__,opt__17516__auto__){
return cljs.core._write.call(null,writer__17515__auto__,"reagent.impl.batching/RenderQueue");
});
...
var G__22469 = c;
var G__22469__$1 = (((G__22469 == null))?null:(G__22469["props"]));
if((G__22469__$1 == null)){
return null;
} else {
return (G__22469__$1["argv"]);
}
});
...
var G__22471_22472 = (c["cljsRatom"]);
if((G__22471_22472 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__22471_22472);
}

return reagent.impl.batching.mark_rendered.call(null,c);
});

//# sourceMappingURL=batching.js.map?rel=1450953131781